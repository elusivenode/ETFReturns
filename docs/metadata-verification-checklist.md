...
| VEU.AX | Vanguard All-World ex-US Shares Index ETF | pending | Added to watchlist and app universe; verify fee and source document (PDS/fact sheet) before setting feeVerified true |
| BGBL.AX | BetaShares Global Shares ETF | pending | Added to watchlist and app universe; verify fee and source document (PDS/fact sheet) before setting feeVerified true |
